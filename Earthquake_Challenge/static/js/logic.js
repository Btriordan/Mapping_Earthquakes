...
// Create the map object wiht center, zoom level and default layer.
let map = L.map('mapid', {
  center: [39.5,-98.5],
  zoom: 3,
  layers: [streets]
...
// Creating a GeoJSON layer with the retrieved data.
    ...
    // Tectonic plate syle info
    function styleInfoTectonic(feature) {
        return {
          color: "#ea2c2c",
        };
      }
...
d3.json(tectonicPlate).then(function(data) {
 ...
 // Creating a GeoJSON layer with the retrieved data.
    L.geoJson(data, {
        lineString: function(feature, latlng) {
            console.log(data);
